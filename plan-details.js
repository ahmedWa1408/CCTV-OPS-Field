document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1. قاعدة البيانات الذكية للمسارات الستة التي حددتها
    ...
    // 2. استدعاء الرقم المختار تلقائياً من الذاكرة المؤقتة لمتصفحك
    const selectedPlan = localStorage.getItem('selectedPlanNumber') || "01";
    
    // عرض رقم الخطة المحفوظ في مكانه المخصص بالصفحة
    displayNum.innerText = selectedPlan;

    // التحقق وعرض اسم المسار المطابق بدقة، أو عرض تنبيه إذا كان الرقم غير مسجل
    if (routesDatabase[selectedPlan]) {
        ...
        displayRoute.style.color = "#ef4444"; // لون أحمر تنبيهي في حال إدخال رقم خطة آخر
    }

    // 3. مزامنة تفضيلات المظهر (داكن / فاتح) مع الصفحات السابقة
